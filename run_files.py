...
options.register("sonic", False, VarParsing.multiplicity.singleton, VarParsing.varType.bool, "enable SONIC in workflow")
...
if options.sonic:
    ...
    #process.TritonService.fallback.tempDir = "/srv/tmp/"
