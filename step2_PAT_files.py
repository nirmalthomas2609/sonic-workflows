...
for line in linesOfFiles:
    ...
    #print('/gcs'+line[:-1])
    #print('/mnt/hadoop'+line[:-1])
    print("Condition - ", path.exists(cwd+'/'+line.split("/")[-1][:-1]))
    if(path.exists(cwd+'/'+line.split("/")[-1][:-1])):
    #if(path.exists('/gcs'+line[:-1])):
    #if(path.exists('/mnt/hadoop'+line[:-1])):
        print("Inside append.")
        inFiles.append('file:'+cwd+'/'+line.split("/")[-1][:-1])
        #inFiles.append('file:/gcs'+line[:-1])
        #inFiles.append('file:/mnt/hadoop'+line[:-1])
        print('appending file:'+cwd+'/'+line.split("/")[-1][:-1])
        #print('appending file:/gcs'+line[:-1])
        #print('appending file:/mnt/hadoop'+line[:-1])
